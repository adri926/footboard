import type { ConceptFrame } from "@/components/pitch/ConceptAnimation"
...
//
// Données extraites de la page Concepts pour être réutilisées par la boucle IA
// (lib/coach-loop.ts) : un axe de progrès détecté sur une vidéo pointe vers le
// concept animé correspondant.
