...
export const SCENARIOS: TacticalScenario[] = [
  ...
  /* ── ATTAQUE 1 — Conservation de balle ── */
  {
    ...
    ball: { x: 50, y: 46 },
    home: [
      { id: 1,  role: "GK",  x: 50, y:  8 },
      { id: 2,  role: "RB",  x: 72, y: 28 },
      { id: 3,  role: "CB",  x: 40, y: 22 },
      { id: 4,  role: "CB",  x: 60, y: 22 },
      { id: 5,  role: "LB",  x: 28, y: 28 },
      { id: 6,  role: "CDM", x: 50, y: 40 },
      { id: 7,  role: "CM",  x: 32, y: 52 },
      { id: 8,  role: "CM",  x: 68, y: 52 },
      { id: 9,  role: "RW",  x: 80, y: 38 },
      { id: 10, role: "ST",  x: 50, y: 60 },
      { id: 11, role: "LW",  x: 20, y: 38 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 72, y: 76 },
      { id: 3,  role: "CB",  x: 40, y: 80 },
      { id: 4,  role: "CB",  x: 60, y: 80 },
      { id: 5,  role: "LB",  x: 28, y: 76 },
      { id: 6,  role: "RM",  x: 72, y: 65 },
      { id: 7,  role: "CM",  x: 40, y: 62 },
      { id: 8,  role: "CM",  x: 60, y: 62 },
      { id: 9,  role: "LM",  x: 28, y: 65 },
      { id: 10, role: "ST",  x: 40, y: 55 },
      { id: 11, role: "ST",  x: 60, y: 55 },
    ],
  },
  ...
  /* ── ATTAQUE 2 — Attaque rapide ── */
  {
    ...
    home: [
      { id: 1,  role: "GK",  x: 50, y:  8 },
      { id: 2,  role: "RB",  x: 80, y: 38 },
      { id: 3,  role: "CB",  x: 40, y: 18 },
      { id: 4,  role: "CB",  x: 60, y: 18 },
      { id: 5,  role: "LB",  x: 20, y: 38 },
      { id: 6,  role: "CDM", x: 50, y: 36 },
      { id: 7,  role: "CM",  x: 30, y: 52 },
      { id: 8,  role: "CM",  x: 70, y: 52 },
      { id: 9,  role: "RW",  x: 84, y: 62 },
      { id: 10, role: "ST",  x: 50, y: 70 },
      { id: 11, role: "LW",  x: 16, y: 62 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 74, y: 55 },
      { id: 3,  role: "CB",  x: 40, y: 62 },
      { id: 4,  role: "CB",  x: 60, y: 62 },
      { id: 5,  role: "LB",  x: 26, y: 55 },
      { id: 6,  role: "RM",  x: 76, y: 44 },
      { id: 7,  role: "CM",  x: 40, y: 46 },
      { id: 8,  role: "CM",  x: 60, y: 46 },
      { id: 9,  role: "LM",  x: 24, y: 44 },
      { id: 10, role: "ST",  x: 42, y: 36 },
      { id: 11, role: "ST",  x: 58, y: 36 },
    ],
  },
  ...
  /* ── ATTAQUE 3 — Jeu en profondeur ── */
  {
    ...
    home: [
      { id: 1,  role: "GK",  x: 50, y:  8 },
      { id: 2,  role: "RB",  x: 78, y: 30 },
      { id: 3,  role: "CB",  x: 40, y: 20 },
      { id: 4,  role: "CB",  x: 60, y: 20 },
      { id: 5,  role: "LB",  x: 22, y: 30 },
      { id: 6,  role: "CDM", x: 50, y: 40 },
      { id: 7,  role: "CM",  x: 34, y: 52 },
      { id: 8,  role: "CM",  x: 66, y: 52 },
      { id: 9,  role: "RW",  x: 90, y: 46 },
      { id: 10, role: "ST",  x: 50, y: 74 },
      { id: 11, role: "LW",  x: 10, y: 46 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 72, y: 70 },
      { id: 3,  role: "CB",  x: 40, y: 66 },
      { id: 4,  role: "CB",  x: 60, y: 66 },
      { id: 5,  role: "LB",  x: 28, y: 70 },
      { id: 6,  role: "RM",  x: 72, y: 56 },
      { id: 7,  role: "CM",  x: 40, y: 54 },
      { id: 8,  role: "CM",  x: 60, y: 54 },
      { id: 9,  role: "LM",  x: 28, y: 56 },
      { id: 10, role: "ST",  x: 42, y: 42 },
      { id: 11, role: "ST",  x: 58, y: 42 },
    ],
  },
  ...
  /* ── DÉFENSE 1 — Bloc bas ── */
  {
    ...
    ball: { x: 50, y: 52 },
    home: [
      { id: 1,  role: "GK",  x: 50, y: 10 },
      { id: 2,  role: "RB",  x: 74, y: 26 },
      { id: 3,  role: "CB",  x: 40, y: 20 },
      { id: 4,  role: "CB",  x: 60, y: 20 },
      { id: 5,  role: "LB",  x: 26, y: 26 },
      { id: 6,  role: "RM",  x: 74, y: 36 },
      { id: 7,  role: "CM",  x: 40, y: 38 },
      { id: 8,  role: "CM",  x: 60, y: 38 },
      { id: 9,  role: "LM",  x: 26, y: 36 },
      { id: 10, role: "AM",  x: 50, y: 46 },
      { id: 11, role: "ST",  x: 50, y: 54 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 78, y: 68 },
      { id: 3,  role: "CB",  x: 40, y: 74 },
      { id: 4,  role: "CB",  x: 60, y: 74 },
      { id: 5,  role: "LB",  x: 22, y: 68 },
      { id: 6,  role: "CDM", x: 50, y: 60 },
      { id: 7,  role: "CM",  x: 32, y: 52 },
      { id: 8,  role: "CM",  x: 68, y: 52 },
      { id: 9,  role: "RW",  x: 82, y: 42 },
      { id: 10, role: "ST",  x: 50, y: 38 },
      { id: 11, role: "LW",  x: 18, y: 42 },
    ],
  },
  ...
  /* ── DÉFENSE 2 — Bloc médian ── */
  {
    ...
    home: [
      { id: 1,  role: "GK",  x: 50, y: 10 },
      { id: 2,  role: "RB",  x: 74, y: 28 },
      { id: 3,  role: "CB",  x: 40, y: 22 },
      { id: 4,  role: "CB",  x: 60, y: 22 },
      { id: 5,  role: "LB",  x: 26, y: 28 },
      { id: 6,  role: "RM",  x: 74, y: 44 },
      { id: 7,  role: "CM",  x: 40, y: 46 },
      { id: 8,  role: "CM",  x: 60, y: 46 },
      { id: 9,  role: "LM",  x: 26, y: 44 },
      { id: 10, role: "ST",  x: 40, y: 58 },
      { id: 11, role: "ST",  x: 60, y: 58 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 78, y: 70 },
      { id: 3,  role: "CB",  x: 40, y: 76 },
      { id: 4,  role: "CB",  x: 60, y: 76 },
      { id: 5,  role: "LB",  x: 22, y: 70 },
      { id: 6,  role: "CDM", x: 50, y: 62 },
      { id: 7,  role: "CM",  x: 32, y: 54 },
      { id: 8,  role: "CM",  x: 68, y: 54 },
      { id: 9,  role: "RW",  x: 80, y: 46 },
      { id: 10, role: "ST",  x: 50, y: 40 },
      { id: 11, role: "LW",  x: 20, y: 46 },
    ],
  },
  ...
  /* ── DÉFENSE 3 — Pressing haut ── */
  {
    ...
    ball: { x: 50, y: 80 },
    home: [
      { id: 1,  role: "GK",  x: 50, y: 20 },
      { id: 2,  role: "RB",  x: 74, y: 40 },
      { id: 3,  role: "CB",  x: 40, y: 34 },
      { id: 4,  role: "CB",  x: 60, y: 34 },
      { id: 5,  role: "LB",  x: 26, y: 40 },
      { id: 6,  role: "RM",  x: 74, y: 54 },
      { id: 7,  role: "CM",  x: 40, y: 56 },
      { id: 8,  role: "CM",  x: 60, y: 56 },
      { id: 9,  role: "LM",  x: 26, y: 54 },
      { id: 10, role: "ST",  x: 40, y: 68 },
      { id: 11, role: "ST",  x: 60, y: 68 },
    ],
    away: [
      { id: 1,  role: "GK",  x: 50, y: 92 },
      { id: 2,  role: "RB",  x: 72, y: 80 },
      { id: 3,  role: "CB",  x: 40, y: 84 },
      { id: 4,  role: "CB",  x: 60, y: 84 },
      { id: 5,  role: "LB",  x: 28, y: 80 },
      { id: 6,  role: "CDM", x: 50, y: 72 },
      { id: 7,  role: "CM",  x: 36, y: 64 },
      { id: 8,  role: "CM",  x: 64, y: 64 },
      { id: 9,  role: "RW",  x: 72, y: 56 },
      { id: 10, role: "ST",  x: 50, y: 50 },
      { id: 11, role: "LW",  x: 28, y: 56 },
    ],
  },
]
