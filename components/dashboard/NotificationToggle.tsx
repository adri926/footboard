...
// Équivalent coach de components/joueur/NotificationToggle.tsx — même infra (subscribePush/
// unsubscribePush sont génériques, liées au userId Clerk, pas spécifiques aux joueurs), juste
// un texte différent. Sert notamment à prévenir le coach quand une analyse vidéo IA est prête.
      ...
      <div>
        ...
        <p style={{
          ...
          {status === "denied"
            ...
            : status === "subscribed"
              ? "Tu reçois une alerte quand une analyse vidéo IA est prête."
              : "Active les notifications pour être prévenu dès qu'une analyse vidéo IA est prête."}
        </p>
      </div>
      {status === "unsubscribed" && (
